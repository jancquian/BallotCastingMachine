...
class Exporter:
    ...
    @staticmethod
    def b64_to_dictionary(b64_string):
        bytes_string = Exporter.b64_to_bytes(b64_string)
        json_string = Exporter.bytes_to_json(bytes_string)
        return Exporter.json_to_dictionary(json_string)
